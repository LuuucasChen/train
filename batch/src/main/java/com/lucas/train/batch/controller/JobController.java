...
import com.lucas.train.batch.req.CronJobReq;
import com.lucas.train.batch.resp.CronJobResp;
import org.quartz.*;
...
public class JobController {
    ...
    public CommonResp run(@RequestBody CronJobReq cronJobReq) throws SchedulerException {
        String jobReqName = cronJobReq.getName();
        String group = cronJobReq.getGroup();
        LOG.info("手动执行任务开始:{},{}", jobReqName, group);
        schedulerFactoryBean.getScheduler().triggerJob(JobKey.jobKey(jobReqName,group));
